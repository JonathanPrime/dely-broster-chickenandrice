...
function displayCart() {
  ...
  for(var i in cartArray) {
    output += "<tr>"
      ...
      + " = " 
      + "<td id='total_cant'>" + cartArray[i].total + "</td>" 
      +  "</tr>";
  }
...
$('#customers-testimonials-arr').owlCarousel({
  interval: false,
  nav: true,
...
/* let btnfilteclas = document.querySelector('.cls');
let btnfiltepll = document.querySelector('.pll'); */
/* let btnfiltearr = document.querySelector('.arr'); */
/* 
btnfilteclas.addEventListener("click", () => {
...
/* btnfiltepll.addEventListener("click", () => {
  $('.owl-filter-pll').on('click', '.item', function () {
    var $item = $(this);
    var filter = $item.data('owl-filter')
    owl.owlcarousel2_filter(filter);
  });
  var owl = $('.owl-carousel-pll').owlCarousel({
    loop: true,
    margin: 10,
    nav: true,
    items: 3,
...
/* btnfiltearr.addEventListener("click", () => {
  $('.owl-filter-arr').on('click', '.item', function () {
    var $item = $(this);
    var filter = $item.data('owl-filter')
    owl.owlcarousel2_filter(filter);
  });
  var owl = $('.owl-carousel-arr').owlCarousel({
    loop: true,
    margin: 10,
    nav: true,
    items: 3,
...
popupWhatsApp = () => {
  ...
  sendBtn.addEventListener("click", () => {
    ...
    window.open('https://wa.me/573138813310?text=' + relmsg, '_blank');
...
/* sendOrder = () => { */
  ...
  sendOrderBtn.addEventListener("click", () => {
    ...
    if (name == null || tel == null || dir == null 
     ...
     window.open('https://wa.me/573138813310?text='+ relmsg + "%0a"
    + "---------------------------------" + "%0a"
    + "       DATOS DEL PEDIDO          " + "%0a"
    + "---------------------------------" + "%0a"
    + carritoEnTexto + "%0a"
